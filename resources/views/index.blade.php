...
<section class="kategori" style="background-color: #000000">
        ...
        <div class="row">
            @foreach($categories as $category)
                <div class="col-md-4 col-sm-6 bg-danger">
                    <div class="card mb-30 bg-danger"><a class="card-img-tiles" data-abc="true">
                            <div class="inner">
...
<section class="seller">
    ...
    <div class="container mt-100">
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
            <a href="/seller" style="text-decoration: none; color:#000"><h1 class="h2">Sellers</h1></a>
        </div>
        <div class="container-fluid py-5 mx-auto bg-dark">
            <div class="row">
