...
<nav class="navbar sticky-top" style="background-color: rgb(170, 170, 170); padding: 4px 16px; line-height: 0.5;">
    <div class="container-fluid d-flex justify-content-between">
        ...
        <div class="d-flex align-items-end ml-auto">
            <a class="navbar-brand" style="font-size: 80%;" href="https://chat.openai.com/share/80b6d05e-7b77-40c0-a46f-b8f7245d5e5f">Tentang TABASCOPEDIA</a>
...
<nav class="navbar sticky-top" style="background-color: #6e0f0f">
    <div class="container-fluid d-flex justify-content-between align-items-center">
        <a class="navbar-brand" href="/">
            <img src="{{ asset('img/BANDAILOGO.png') }}" alt="Logo" width="250"
        ...
        <div class="d-flex">
            ...
            <div class="input-group has-validation ms-3">
                <div class="form-floating">
                    <input type="text" class="form-control custom-search-input rounded-pill" id="search" name="search"
                        placeholder="{{ $search }}" required>
                    <label for="floatingInputGroup2">{{ $search }}</label>
                </div>
                <span class="input-group-text rounded-circle"><i class="bi bi-search"></i></span>
            </div>
        </div>
        @auth
        <li class="nav-item">
